...
public class CostOptimizationService {
  private final CloudResourceRepository resources; private final RecommendationRepository recommendations; private final AzureCostService costs;
  @Value("${azure.subscription-id:}") private String subscriptionId;
  public CostOptimizationService(CloudResourceRepository resources, RecommendationRepository recommendations, AzureCostService costs){this.resources=resources;this.recommendations=recommendations;this.costs=costs;}
